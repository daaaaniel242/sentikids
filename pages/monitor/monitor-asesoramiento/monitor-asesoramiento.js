function openPopup() {
    ...
    fetch('monitor-asesoramiento.php')
        ...
        .catch(error => {
            ...
            showCustomAlert("Error al cargar tutores: " + error.message);
        });
}
    ...
    if (form) {
        form.addEventListener("submit", function (event) {
            ...
            if (!recipient || !title || !message) {
                showCustomAlert("SENTIKIDS:  Por favor, complete todos los campos.");
                return;
            }
            ...
            .then(data => {
                ...
                if (data.status === "success") {
                    showCustomAlert("SENTIKIDS: ¡Notificación enviada con éxito!");
...
function cargarNombreMonitor() {
    ...
    fetch("obtener_nombre_monitor.php")
        ...
        .catch(error => {
            ...
            // showCustomAlert("Error al cargar el nombre del monitor: " + error.message);
        });
}
...
function cargarNotificaciones() {
    fetch("cargar_notificaciones.php")
        ...
        .catch(error => {
            ...
            // showCustomAlert("Error al cargar notificaciones: " + error.message);
        });
}
